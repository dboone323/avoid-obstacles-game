        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            GroupBox("Export") {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    HStack {
                        Button("Export to CSV").accessibilityLabel("Button") {
                            // Export functionality
                        }

                        Button("Export to JSON").accessibilityLabel("Button") {
                            // Export functionality
                        }
                    }
                }
            ...
            GroupBox("Import") {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Button("Import Data").accessibilityLabel("Button") {
...
struct AdvancedSettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Performance") {
                Button("Clear Cache").accessibilityLabel("Button") {
                    // Clear cache functionality
                }

                Button("Reset All Settings").accessibilityLabel("Button") {
