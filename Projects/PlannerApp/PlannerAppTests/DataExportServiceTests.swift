...
final class DataExportServiceTests: XCTestCase {
    private func makeInMemoryContainer() throws -> ModelContainer {
        let schema = Schema([
            ...
            // Example: Task.self, Project.self, etc.
        ])
    ...
    func testExportImportRoundTrip() throws {
        ...
        // Add sample data for PlannerApp models
        // Example:
        // let task = Task(title: "Test Task", description: "Test description", dueDate: Date())
        // sourceContext.insert(task)

        try sourceContext.save()

        // Act: export from source and import into destination in-memory store
        // Note: This assumes you have a DataExportService in PlannerApp
        ...
        // let taskCount = try destContext.fetch(FetchDescriptor<Task>()).count
