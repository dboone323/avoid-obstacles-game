...
@MainActor
enum AvoidObstaclesLifecycleCoordinator {
    static func configureOnLaunch() {
        UserDefaults.standard.register(defaults: [
            "aog_notifications_enabled": true,
            "aog_haptics_enabled": true,
            "aog_reduce_motion": false,
        ])

        if AvoidObstaclesSecureStore.bool(forKey: "aog.biometric_enabled") == nil {
            _ = AvoidObstaclesSecureStore.set(false, forKey: "aog.biometric_enabled")
        }
...
enum AvoidObstaclesSecureStore {
    ...
    static func set(_ data: Data, forKey key: String) -> Bool {
        let query: [String: Any] = [
            ...
            kSecAttrService as String: Bundle.main.bundleIdentifier ?? "AvoidObstaclesGame",
