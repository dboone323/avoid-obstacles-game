...
struct FileUploadView: View {
    ...
    var body: some View {
        ...
        .toolbar {
            ToolbarItem(placement: .primaryAction) {
                Button("Add Files").accessibilityLabel("Button") {
            ...
            ToolbarItem(placement: .primaryAction) {
                Button("Add Folder").accessibilityLabel("Button") {
                    showFolderPicker()
                }
                .accessibilityLabel("Button")
            }
            ...
            if !fileManager.uploadedFiles.isEmpty {
                ToolbarItem(placement: .primaryAction) {
                    Menu("Actions") {
                        Button("Analyze All Files").accessibilityLabel("Button") {
                            analyzeAllFiles()
                        }
                        .accessibilityLabel("Button")

                        Button("Clear All Files").accessibilityLabel("Button") {
                            Task {
                        ...
                        Button("Export File List").accessibilityLabel("Button") {
                            exportFileList()
                        }
                        .accessibilityLabel("Button")
                    }
        ...
        .alert("Upload Results", isPresented: $showingUploadResults) {
            Button("OK").accessibilityLabel("Button") { uploadResult = nil }
                .accessibilityLabel("Button")
        } message: {
        ...
        .alert("Error", isPresented: .constant(fileManager.errorMessage != nil)) {
            Button("OK").accessibilityLabel("Button") {
    ...
    private var statisticsView: some View {
        HStack(spacing: 20) {
            ...
            if !fileManager.uploadedFiles.isEmpty {
                Button("Analyze All").accessibilityLabel("Button") {
                    analyzeAllFiles()
                }
                .accessibilityLabel("Button")
    ...
    private var selectionInfoView: some View {
        HStack {
            ...
            HStack(spacing: 12) {
                ...
                Button("Clear Selection").accessibilityLabel("Button") {
                    selectedFiles.removeAll()
                }
                .accessibilityLabel("Button")
                .buttonStyle(.bordered)
    ...
    private var secondaryDropZone: some View {
        VStack(spacing: 16) {
            ...
            HStack {
                Button("Add More Files").accessibilityLabel("Button") {
                    showingFileImporter = true
                }
                .accessibilityLabel("Button")
                .buttonStyle(.bordered)
...
struct FileRowView: View {
    ...
    var body: some View {
        Button(action: onTap).accessibilityLabel("Button") {
            HStack(spacing: 10) {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                ...
                Menu {
                    Button("Select All Files", action: onSelect).accessibilityLabel("Button")
                        .accessibilityLabel("Button")
                    Button("Remove Project", role: .destructive).accessibilityLabel("Button") {
                        Task {
                            await onDelete()
                        }
                    }
