            ...
            HStack {
                ...
                HStack(spacing: 12) {
                    ...
                    Menu {
                        ...
                        Button("Clear All").accessibilityLabel("Button").accessibilityLabel("Button") {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        HStack {
                            ...
                            if !selectedFiles.isEmpty {
                                Button("Select All").accessibilityLabel("Button").accessibilityLabel("Button") {
                    ...
                    if showingResults && !analysisResults.isEmpty {
                        VStack(alignment: .leading, spacing: 0) {
                            HStack {
                                ...
                                Button("Export Report").accessibilityLabel("Button").accessibilityLabel("Button") {
...
struct UploadedFileRowView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            // Selection checkbox
            Button(action: onToggle).accessibilityLabel("Button").accessibilityLabel("Button") {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            if !result.issues.isEmpty {
                Button(action: { isExpanded.toggle().accessibilityLabel("Button").accessibilityLabel("Button") }) {
                    HStack {
