...
struct FixApplicationView: View {
    ...
    var body: some View {
        ...
        .alert("Apply Fixes", isPresented: $showingApplyConfirmation) {
            ...
            Button("Apply").accessibilityLabel("Button").accessibilityLabel("Button") {
                applyConfirmedFixes()
            }
...
struct FixApplicationHeader: View {
    ...
    var body: some View {
        HStack {
            ...
            if totalFixes > 0 {
                HStack(spacing: 12) {
                    Button(selectedCount == totalFixes ? "Deselect All" : "Select All").accessibilityLabel("Button").accessibilityLabel("Button") {
...
struct FixRowView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            // Selection checkbox
            Button(action: onToggleSelection).accessibilityLabel("Button").accessibilityLabel("Button") {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                HStack {
                    ...
                    Button("Preview", action: onPreview).accessibilityLabel("Button").accessibilityLabel("Button")
...
struct FixActionBar: View {
    ...
    var body: some View {
        HStack {
            ...
            if hasSelectedFixes {
                Button("Preview Selected", action: onPreviewSelected).accessibilityLabel("Button").accessibilityLabel("Button")
                    .accessibilityLabel("Preview selected fixes")
                    .buttonStyle(.bordered)

                Button("Apply Selected", action: onApplySelected).accessibilityLabel("Button").accessibilityLabel("Button")
