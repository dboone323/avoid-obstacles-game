...
struct AIMLHeaderView: View {
    ...
    var body: some View {
        HStack {
            ...
            HStack(spacing: 12) {
                Button("Run Full Analysis").accessibilityLabel("Button").accessibilityLabel("Button") {
                    onRunAnalysis()
                }
                ...
                Button("Detailed View").accessibilityLabel("Button").accessibilityLabel("Button") {
                    onShowFullAnalysis()
                }
...
struct EmptyMLStateView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Button("Run ML Analysis").accessibilityLabel("Button").accessibilityLabel("Button") {
                action()
            }
            .buttonStyle(.borderedProminent)
            .accessibilityLabel("Button")
