...
struct AIDashboardView: View {
    ...
    private func HeaderView(
        ...
        HStack {
            ...
            Button(action: onRefresh).accessibilityLabel("Button").accessibilityLabel("Button") {
    ...
    private func TabButton(tab: DashboardTab, isSelected: Bool, onTap: @escaping ().accessibilityLabel("Button").accessibilityLabel("Button") -> Void)
    -> some View {
