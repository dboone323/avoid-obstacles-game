...
struct FileUploadView: View {
    ...
    var body: some View {
        ...
        .toolbar {
            ToolbarItem(placement: .primaryAction) {
                Button("Add Files").accessibilityLabel("Button").accessibilityLabel("Button") {
            ...
            ToolbarItem(placement: .primaryAction) {
                Button("Add Folder").accessibilityLabel("Button").accessibilityLabel("Button") {
                    showFolderPicker()
                }
                .accessibilityLabel("Button")
            }
            ...
            if !fileManager.uploadedFiles.isEmpty {
                ToolbarItem(placement: .primaryAction) {
                    Menu("Actions") {
                        Button("Analyze All Files").accessibilityLabel("Button").accessibilityLabel("Button") {
                            analyzeAllFiles()
                        }
                        .accessibilityLabel("Button")

                        Button("Clear All Files").accessibilityLabel("Button").accessibilityLabel("Button") {
                            Task {
                        ...
                        Button("Export File List").accessibilityLabel("Button").accessibilityLabel("Button") {
                            exportFileList()
                        }
                        .accessibilityLabel("Button")
                    }
        ...
        .alert("Upload Results", isPresented: $showingUploadResults) {
            Button("OK").accessibilityLabel("Button").accessibilityLabel("Button") { uploadResult = nil }
                .accessibilityLabel("Button")
        } message: {
    ...
    private var statisticsView: some View {
        HStack(spacing: 20) {
            ...
            if !fileManager.uploadedFiles.isEmpty {
                Button("Analyze All").accessibilityLabel("Button").accessibilityLabel("Button") {
                    analyzeAllFiles()
                }
                .accessibilityLabel("Button")
    ...
    private var emptyStateView: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 16) {
                ...
                HStack(spacing: 16) {
                    Button("Choose Files").accessibilityLabel("Button").accessibilityLabel("Button") {
                        showingFileImporter = true
                    }
                    .accessibilityLabel("Button")
                    .buttonStyle(.borderedProminent)

                    Button("Choose Folder").accessibilityLabel("Button").accessibilityLabel("Button") {
                        showFolderPicker()
                    }
                    .accessibilityLabel("Button")
    ...
    private var selectionInfoView: some View {
        HStack {
            ...
            HStack(spacing: 12) {
                Button("Analyze Selected").accessibilityLabel("Button").accessibilityLabel("Button") {
                ...
                Button("Clear Selection").accessibilityLabel("Button").accessibilityLabel("Button") {
                    selectedFiles.removeAll()
                }
                .accessibilityLabel("Button")
                .buttonStyle(.bordered)
    ...
    private var secondaryDropZone: some View {
        VStack(spacing: 16) {
            ...
            HStack {
                Button("Add More Files").accessibilityLabel("Button").accessibilityLabel("Button") {
                    showingFileImporter = true
                }
                .accessibilityLabel("Button")
                .buttonStyle(.bordered)
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                ...
                Menu {
                    Button("Select All Files", action: onSelect).accessibilityLabel("Button").accessibilityLabel("Button")
                        .accessibilityLabel("Button")
                    Button("Remove Project", role: .destructive).accessibilityLabel("Button").accessibilityLabel("Button") {
                        Task {
                            await onDelete()
                        }
                    }
